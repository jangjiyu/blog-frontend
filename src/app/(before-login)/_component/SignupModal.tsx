...
export default function SignupModal() {
  ...
  const onChangeProfileImgFile: ChangeEventHandler<HTMLInputElement> = (e) => {
    e.target.files && setProfileImgFile(e.target.files[0]);
  };
        ...
        <div className={style.modal}>
          ...
          <form>
            <div className={style.modalBody}>
              ...
              <div className={style.inputDiv}>
                <label className={style.inputLabel} htmlFor="profileImg">
                  프로필
                </label>
                <input
                  id="profileImg"
